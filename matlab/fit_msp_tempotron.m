...
function [w, t_crit, dv_dw, errs, outputs, w_hist, anneal_lr, t_adam] = fit_msp_tempotron(ts, trials, labels, w, V_thresh, V_rest, tau_m, tau_s, lr, n_iter, optimizer, fn_target)
    ...
    for i=1:size(trials,1)
        ...
        [v_t, t_out, t_out_idx, v_unreset, ~, ~, V_0, tau_m, tau_s] = MSPTempotron(memo_exp, ts, pattern, w, V_thresh, V_rest, tau_m, tau_s);
